  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "7vh 8vw", height: "90vh", boxSizing: "border-box" }}>
        ...
        <div style={{ display: "flex", alignItems: "stretch", marginTop: "5vh", gap: "4vw" }}>
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: "2.2vw", fontWeight: 700, color: "#4a4a68", letterSpacing: "0.14em" }}>
              FREE TIER
            </div>
            <div
              style={{
            ...
            <div style={{ fontSize: "3vw", fontWeight: 500, color: "#4a4a68", marginTop: "1.5vh" }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: "3vw", fontWeight: 500, color: "#4a4a68", marginTop: "1.5vh", lineHeight: 1.35 }}>
      ...
      >
        ...
        <div style={{ fontSize: "2.2vw", fontWeight: 500, color: "#ffffff", opacity: 0.8 }}>04</div>
      </div>
    </div>
  );
}
